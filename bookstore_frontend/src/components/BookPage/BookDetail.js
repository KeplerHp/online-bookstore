...
render() {
    ...
    return (
        <div className={"content"}>
          <div className={"book-detail"} style={{display: 'inline-block', height: '800px'}}>
            <div className={"book-image"} style={{display: 'inline-block'}}>
              <img alt="" src={this.state.detail.image}
                   style={{width: "400px", height: "400px"}}/>
            </div>
            <div className={"descriptions"}
                 style={{display: 'inline-block', left: 500, verticalAlign: 'top'}}>
              <Descriptions>
